...
export function Filters (): JSX.Element {
  ...
  return (
    <div id='filters' className='relative'>
      ...
      >
        <li onClick={() => setFilter(REGIONS.Africa)} className='p-3 dark:text-white rounded-md cursor-pointer hover:bg-light-input transition-colors'>
          {REGIONS.Africa}
        </li>
        <li onClick={() => setFilter(REGIONS.America)} className='p-3 dark:text-white rounded-md cursor-pointer hover:bg-light-input transition-colors'>
          {REGIONS.America}
        </li>
        <li onClick={() => setFilter(REGIONS.Asia)} className='p-3 dark:text-white rounded-md cursor-pointer hover:bg-light-input transition-colors'>
          {REGIONS.Asia}
        </li>
        <li onClick={() => setFilter(REGIONS.Europe)} className='p-3 dark:text-white rounded-md cursor-pointer hover:bg-light-input transition-colors'>
          {REGIONS.Europe}
        </li>
        <li onClick={() => setFilter(REGIONS.Oceania)} className='p-3 dark:text-white rounded-md cursor-pointer hover:bg-light-input transition-colors'>
          {REGIONS.Oceania}
        </li>
      </ul>
    </div>
